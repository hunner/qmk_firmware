 ...
 */
[_BASE] = LAYOUT_georgi(
    KC_NO, KC_QUOT, KC_COMM, KC_DOT, KC_P, KC_Y, /**/ KC_F, KC_G, KC_C, KC_R, KC_L,
    //LSFT_T(KC_A), LCTL_T(KC_O), LALT_T(KC_E), LGUI_T(KC_U), KC_I, /**/ KC_D, LGUI_T(KC_H), LALT_T(KC_T), LCTL_T(KC_N), LSFT_T(KC_S),
    KC_NO, KC_SCLN, KC_Q, KC_J, KC_K, KC_X, /**/ KC_B, KC_M, KC_W, KC_V, KC_Z,

    KC_ESC, KC_DELETE, LT(_SYMB, KC_BSPC), /**/ LT(_NUMB, KC_SPC), KC_ENT, KC_TAB
    ),
 ...
 */
[_SYMB] = LAYOUT_georgi(
    KC_NO, KC_EXLM, KC_AT  , KC_HASH, KC_DLR , KC_PERC,   KC_CIRC, KC_AMPR, KC_ASTR, KC_BSLS, KC_PIPE,
    //KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, KC_PGUP,   KC_PLUS, KC_MINS, KC_SLSH, KC_ASTR, KC_MINS,
    KC_NO, KC_GRV , KC_TILD, KC_LBRC, KC_RBRC, KC_PGDN,   KC_EQL , KC_TRNS, KC_TRNS, KC_TRNS, KC_QUOT,
                      CMB_TOG, KC_SCLN, KC_TRNS,   KC_TRNS, KC_SCLN, KC_DEL
    ),
...
[_NUMB] = LAYOUT_georgi(
    ...
    KC_NO, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10,       KC_VOLD, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,
 ...
 * ##               `------+------+------'          `------+------+------'
 */
  [_ADJUST] = LAYOUT_georgi(
      KC_NO, KC_NO, KC_NO, KC_NO, TO(_STENO), KC_NO, /**/ KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,
